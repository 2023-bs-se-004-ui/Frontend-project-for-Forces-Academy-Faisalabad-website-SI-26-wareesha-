...
* Detailed courses/program cards
...
* Back-to-top button
* Button and navigation hover effects
...
1. **Home** — Introduction, hero section, statistics, courses, and highlights
2. **About** — Academy information and educational vision
3. **Courses** — Available programs and course details
4. **Admissions** — Admission process, eligibility, documents, and fee information
5. **Results** — Student results and academic information
...
For a better development experience, you can use the **Live Server** extension in VS Code and click:
